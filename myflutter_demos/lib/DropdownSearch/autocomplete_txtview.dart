...
import 'package:myflutter_demos/DropdownSearch/statesModel.dart';

import 'package:search_choices/search_choices.dart';



void main() => AutoTxtView();

class AutoTxtView extends StatefulWidget {
  static final navKey = new GlobalKey<NavigatorState>();

  const AutoTxtView({Key? navKey}) : super(key: navKey);
  @override
  _AutoTxtViewState createState() => _AutoTxtViewState();
}

class _AutoTxtViewState extends State<AutoTxtView> {
  bool asTabs = false;
  ...
  ExampleNumber.list.map((exNum) {
    return (DropdownMenuItem(child: Text(exNum.toString()), value: exNum));
  }).toList();
  ...
  Widget build(BuildContext context) {
      ...
      "Single dialog dark mode": Card(
        ...
        child: SearchChoices.single(
          ...
          closeButton: TextButton(
            onPressed: () {
              Navigator.pop(
                  AutoTxtView.navKey.currentState?.overlay?.context ?? context);
            },
            child: Text(
              "Close",
              style: TextStyle(color: Colors.white),
    ...
    return MaterialApp(
      ...
      navigatorKey: AutoTxtView.navKey,
      home: asTabs
